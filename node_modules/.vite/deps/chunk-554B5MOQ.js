...
} from "./chunk-FQY5NX6X.js";
import {
  DetailMapConfiguration,
  MaterialPluginBase
} from "./chunk-HHQX7HVG.js";
import {
...
var PBRBaseMaterial = class _PBRBaseMaterial extends PBRBaseMaterialBase {
  ...
  _prepareEffect(mesh, renderingMesh, defines, onCompiled = null, onError = null, useInstances = null, useClipPlane = null) {
    ...
    if (this._useVertexPulling) {
      const geometry = renderingMesh == null ? void 0 : renderingMesh.geometry;
      if (geometry) {
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-NLQVQXRQ.js"), import("./pbr.fragment-63LEO7MK.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-AEJSYYTP.js"), import("./pbr.fragment-57GX4ZV7.js")]);
        }
...
//# sourceMappingURL=chunk-554B5MOQ.js.map
