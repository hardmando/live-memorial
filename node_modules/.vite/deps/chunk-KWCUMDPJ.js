...
var name2 = "shadowsFragmentFunctions";
var shader2 = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
var name3 = "imageProcessingDeclaration";
var shader3 = `#ifdef EXPOSURE
...
var name4 = "imageProcessingFunctions";
var shader4 = `#if TONEMAPPING==3
...
var name6 = "ltcHelperFunctions";
var shader6 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var name7 = "clusteredLightingFunctions";
var shader7 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
//# sourceMappingURL=chunk-KWCUMDPJ.js.map
