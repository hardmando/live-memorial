    ...
    if ((_a = this.config) == null ? void 0 : _a.messageTemplate) {
      ...
      for (const match of matches) {
        ...
        if (messageObj !== null && match in messageObj) {
          ...
          value = (_b = this.getDataInput(match)) == null ? void 0 : _b.getValue(context);
        }
        if (value !== void 0) {
...
//# sourceMappingURL=flowGraphConsoleLogBlock-G6NCT4V6.js.map
