...
import {
  ...
  getVector3,
  getWeights
} from "./chunk-52KN7FQF.js";
import {
  Constants
} from "./chunk-WFRDXGED.js";
import {
  AbstractMesh,
  Camera,
  CubeTexture,
  ...
  TransformNode,
  VertexData
} from "./chunk-IRRBBMMV.js";
import {
  Bone
} from "./chunk-YZMFJH2A.js";
import {
  Light
} from "./chunk-63BBNOQK.js";
import {
  Animation,
  AnimationRange,
  Node
} from "./chunk-KGWZ4UNV.js";
import "./chunk-K6A6BJL2.js";
import {
  AutoReleaseWorkerPool
} from "./chunk-QIYPFLPT.js";
import {
  RegisterSceneLoaderPlugin
} from "./chunk-DLI4TAEI.js";
import {
  _UpdateRGBDAsync
} from "./chunk-WYWNSG6H.js";
import "./chunk-NNFBBMLZ.js";
import "./chunk-BL5XEBNJ.js";
import {
  PBRMaterial
} from "./chunk-554B5MOQ.js";
import "./chunk-FQY5NX6X.js";
import "./chunk-6GMRDG2V.js";
import "./chunk-KVCTRQE3.js";
import "./chunk-UF67GV74.js";
import {
  RenderTargetTexture
} from "./chunk-CS24HDJG.js";
import "./chunk-YM4FFEVN.js";
import "./chunk-4U4OQIRL.js";
import "./chunk-6T6YVZWP.js";
import {
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-ZCPHVF4N.js";
import "./chunk-HTXZAHDI.js";
import "./chunk-T3KWZMMR.js";
import "./chunk-KCG2UG3W.js";
import {
  StandardMaterial
} from "./chunk-UZOPVEKF.js";
import "./chunk-HHQX7HVG.js";
import {
  BoundingInfo,
  Material,
  SubMesh
} from "./chunk-CVTRQVWV.js";
import {
  Texture
} from "./chunk-4G3K72E7.js";
import "./chunk-HKSYRDF7.js";
import "./chunk-EM5WVWCO.js";
import "./chunk-ZPN6227P.js";
import "./chunk-YC7U4GEU.js";
import {
  Scene,
  SceneComponentConstants
} from "./chunk-SYPQEJ6K.js";
import "./chunk-4BQ2WYO5.js";
import "./chunk-G77J4TPQ.js";
import {
  SmartArray
} from "./chunk-XGA2HTGY.js";
import "./chunk-LGQOAE5C.js";
import {
  Buffer,
  VertexBuffer
} from "./chunk-S5CHUUVU.js";
import {
  DeepCopier,
  Tools
} from "./chunk-BWSQHK74.js";
import "./chunk-PXSRYJNC.js";
import "./chunk-4YFFFA6Z.js";
import "./chunk-7BCFR62F.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-QN4UTCFI.js";
import {
  Color3,
  Color4
} from "./chunk-B4H6L6JD.js";
import {
  Matrix,
  Quaternion,
  TmpVectors,
  ...
  Vector3,
  Vector4
} from "./chunk-US4S5KVM.js";
import "./chunk-W4YECEEH.js";
import {
  __decorate,
  serialize
} from "./chunk-JY5T53NN.js";
...
import {
  EngineStore
} from "./chunk-WVU3GLVE.js";
import {
  Observable
} from "./chunk-YER65AYQ.js";
...
var Skeleton = class _Skeleton {
   ...
   */
  findBoneFromLinkedTransformNodeName(name2) {
    for (const bone of this.bones) {
      if (bone._linkedTransformNode && bone._linkedTransformNode.name === name2) {
        return bone;
      }
    }
    return null;
    ...
    if (this.needInitialSkinMatrix) {
      for (const mesh of this._meshesWithPoseMatrix) {
        ...
        if (this._synchronizedWithMesh !== mesh) {
          ...
          if (this.isUsingTextureForMatrices) {
            const meshTextureSize = (_a = mesh._transformMatrixTexture) == null ? void 0 : _a.getSize();
...
Node.AddNodeConstructor("Light_Type_1", (name2, scene) => {
...
var DirectionalLight = class extends ShadowLight {
   ...
   */
  constructor(name2, direction, scene, dontAddToScene) {
...
var MorphTarget = class _MorphTarget {
   ...
   */
  constructor(name2, influence = 0, scene = null, morphTargetManager = null) {
    this.name = name2;
    this.animations = [];
  ...
  static FromMesh(mesh, name2, influence) {
    ...
    const result = new _MorphTarget(name2, influence, mesh.getScene(), mesh.morphTargetManager);
...
var LazyAnimationGroupModulePromise = new Lazy(() => import("./animationGroup-XD4RLEE7.js"));
var LazyLoaderAnimationModulePromise = new Lazy(() => import("./glTFLoaderAnimation-2I7SFFT5.js"));
var ArrayItem = class {
  /**
...
var GLTFLoader2 = class _GLTFLoader {
  ...
  dispose() {
    ...
    for (const adapter of Array.from(this._materialAdapters)) {
      (_a = adapter.finalize) == null ? void 0 : _a.call(adapter);
    }
      ...
      if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
        if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
          this._pbrMaterialImpl = {
            materialClass: (await import("./openpbrMaterial-KQRGXQLX.js")).OpenPBRMaterial,
            adapterClass: (await import("./openpbrMaterialLoadingAdapter-7LUCV2FI.js")).OpenPBRMaterialLoadingAdapter
          };
        } else {
          this._pbrMaterialImpl = {
            materialClass: (await import("./@babylonjs_core_Materials_PBR_pbrMaterial.js")).PBRMaterial,
            adapterClass: (await import("./pbrMaterialLoadingAdapter-WQZBDLCY.js")).PBRMaterialLoadingAdapter
          };
        }
      }
...
Mesh.prototype.thinInstanceBufferUpdated = function(kind) {
  ...
  if (kind === "matrix") {
    ...
    (_c = this._thinInstanceDataStorage.matrixBuffer) == null ? void 0 : _c.updateDirectly(this._userThinInstanceBuffersStorage.data[kind], 0, this._thinInstanceDataStorage.instancesCount);
  } else {
    if (kind === VertexBuffer.ColorKind) {
      kind = VertexBuffer.ColorInstanceKind;
    }
    if ((_d = this._userThinInstanceBuffersStorage) == null ? void 0 : _d.vertexBuffers[kind]) {
...
Mesh.prototype._disposeThinInstanceSpecificData = function() {
  ...
  if ((_b = this._thinInstanceDataStorage) == null ? void 0 : _b.previousMatrixBuffer) {
...
function CreateSceneLTCTextures(scene) {
  ...
  DecodeLTCTextureDataAsync().then((textureData) => {
    ...
    if (scene._ltcTextures) {
      const ltc1 = (_a = scene._ltcTextures) == null ? void 0 : _a.LTC1;
      ltc1.update(textureData[0]);
      const ltc2 = (_b = scene._ltcTextures) == null ? void 0 : _b.LTC2;
      ltc2.update(textureData[1]);
      scene.onDisposeObservable.addOnce(() => {
        var _a2, _b2;
        (_a2 = scene._ltcTextures) == null ? void 0 : _a2.LTC1.dispose();
        (_b2 = scene._ltcTextures) == null ? void 0 : _b2.LTC2.dispose();
      });
    }
  }).catch((error) => {
...
var Sound = class _Sound {
  ...
  get isPlaying() {
    var _a;
    return this._soundV2 instanceof _WebAudioSoundSource ? true : ((_a = this._soundV2) == null ? void 0 : _a.state) === 3 || !this.isReady() && this._optionsV2.autoplay;
  }
  /**
  ...
  get spatialSound() {
    var _a;
    return ((_a = this._soundV2) == null ? void 0 : _a._isSpatial) ?? false;
  }
  /**
   * Does this sound enables spatial sound.
   * @see https://doc.babylonjs.com/legacy/audio#creating-a-spatial-3d-sound
  ...
  constructor(name2, urlOrArrayBuffer, scene, readyToPlayCallback = null, options) {
    ...
    let streaming = (options == null ? void 0 : options.streaming) || false;
  ...
  play(time, offset, length) {
    const audioEngine = AbstractEngine.audioEngine;
    audioEngine == null ? void 0 : audioEngine.unlock();
    if (this._soundV2 instanceof _WebAudioSoundSource) {
      return;
    }
    if (this._isReadyToPlay && this._scene.audioEnabled) {
      ...
      try {
        ...
        if (audioEngine == null ? void 0 : audioEngine.unlocked) {
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name2, options = {}) {
    const module = await import("./webAudioBus-P435CN5U.js");
  ...
  async createMainBusAsync(name2, options = {}) {
    const module = await import("./webAudioMainBus-WZ62BCBF.js");
  ...
  async createSoundAsync(name2, source, options = {}) {
    const module = await import("./webAudioStaticSound-UWKQVDMT.js");
  ...
  async createSoundSourceAsync(name2, source, options = {}) {
    const module = await import("./webAudioSoundSource-KO7QUGG5.js");
  ...
  async createStreamingSoundAsync(name2, source, options = {}) {
    const module = await import("./webAudioStreamingSound-JXCJ46CN.js");
  ...
  _onSoundPlaybackStateChanged() {
    ...
    const hasActiveSounds = this.sounds.some(
      (s) => s.state === 3 || s.state === 2 || s.state === 0
      /* SoundState.Stopping */
    );
...
var MSFT_lod = class {
  ...
  constructor(loader) {
    ...
    this._loader = loader;
    this.maxLODsToLoad = ((_a = this._loader.parent.extensionOptions[NAME34]) == null ? void 0 : _a.maxLODsToLoad) ?? this.maxLODsToLoad;
...
function blockFactory(blockName) {
  switch (blockName) {
    case "FlowGraphPlayAnimationBlock":
      return async () => (await import("./flowGraphPlayAnimationBlock-JXPXTUQ3.js")).FlowGraphPlayAnimationBlock;
    case "FlowGraphStopAnimationBlock":
      return async () => (await import("./flowGraphStopAnimationBlock-M6I4SFG2.js")).FlowGraphStopAnimationBlock;
    case "FlowGraphPauseAnimationBlock":
      return async () => (await import("./flowGraphPauseAnimationBlock-XSETRCCM.js")).FlowGraphPauseAnimationBlock;
    case "FlowGraphInterpolationBlock":
      return async () => (await import("./flowGraphInterpolationBlock-QXUZNA3Y.js")).FlowGraphInterpolationBlock;
    case "FlowGraphSceneReadyEventBlock":
      return async () => (await import("./flowGraphSceneReadyEventBlock-XGOMSOVL.js")).FlowGraphSceneReadyEventBlock;
    case "FlowGraphSceneTickEventBlock":
      return async () => (await import("./flowGraphSceneTickEventBlock-STLKOIOF.js")).FlowGraphSceneTickEventBlock;
    case "FlowGraphSendCustomEventBlock":
      return async () => (await import("./flowGraphSendCustomEventBlock-HACTE23Q.js")).FlowGraphSendCustomEventBlock;
    case "FlowGraphReceiveCustomEventBlock":
      return async () => (await import("./flowGraphReceiveCustomEventBlock-2LFQZNFQ.js")).FlowGraphReceiveCustomEventBlock;
    case "FlowGraphMeshPickEventBlock":
      return async () => (await import("./flowGraphMeshPickEventBlock-MURGUQYP.js")).FlowGraphMeshPickEventBlock;
    case "FlowGraphEBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphEBlock;
    case "FlowGraphPIBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphPiBlock;
    case "FlowGraphInfBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphInfBlock;
    case "FlowGraphNaNBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphNaNBlock;
    case "FlowGraphRandomBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphRandomBlock;
    case "FlowGraphAddBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAddBlock;
    case "FlowGraphSubtractBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphSubtractBlock;
    case "FlowGraphMultiplyBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphMultiplyBlock;
    case "FlowGraphDivideBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphDivideBlock;
    case "FlowGraphAbsBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAbsBlock;
    case "FlowGraphSignBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphSignBlock;
    case "FlowGraphTruncBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphTruncBlock;
    case "FlowGraphFloorBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphFloorBlock;
    case "FlowGraphCeilBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphCeilBlock;
    case "FlowGraphRoundBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphRoundBlock;
    case "FlowGraphFractBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphFractionBlock;
    case "FlowGraphNegationBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphNegationBlock;
    case "FlowGraphModuloBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphModuloBlock;
    case "FlowGraphMinBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphMinBlock;
    case "FlowGraphMaxBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphMaxBlock;
    case "FlowGraphClampBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphClampBlock;
    case "FlowGraphSaturateBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphSaturateBlock;
    case "FlowGraphMathInterpolationBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphMathInterpolationBlock;
    case "FlowGraphEqualityBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphEqualityBlock;
    case "FlowGraphLessThanBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphLessThanBlock;
    case "FlowGraphLessThanOrEqualBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphLessThanOrEqualBlock;
    case "FlowGraphGreaterThanBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphGreaterThanBlock;
    case "FlowGraphGreaterThanOrEqualBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphGreaterThanOrEqualBlock;
    case "FlowGraphIsNaNBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphIsNanBlock;
    case "FlowGraphIsInfBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphIsInfinityBlock;
    case "FlowGraphDegToRadBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphDegToRadBlock;
    case "FlowGraphRadToDegBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphRadToDegBlock;
    case "FlowGraphSinBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphSinBlock;
    case "FlowGraphCosBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphCosBlock;
    case "FlowGraphTanBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphTanBlock;
    case "FlowGraphASinBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAsinBlock;
    case "FlowGraphACosBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAcosBlock;
    case "FlowGraphATanBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAtanBlock;
    case "FlowGraphATan2Block":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAtan2Block;
    case "FlowGraphSinhBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphSinhBlock;
    case "FlowGraphCoshBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphCoshBlock;
    case "FlowGraphTanhBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphTanhBlock;
    case "FlowGraphASinhBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAsinhBlock;
    case "FlowGraphACoshBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAcoshBlock;
    case "FlowGraphATanhBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphAtanhBlock;
    case "FlowGraphExponentialBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphExpBlock;
    case "FlowGraphLogBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphLogBlock;
    case "FlowGraphLog2Block":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphLog2Block;
    case "FlowGraphLog10Block":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphLog10Block;
    case "FlowGraphSquareRootBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphSquareRootBlock;
    case "FlowGraphPowerBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphPowerBlock;
    case "FlowGraphCubeRootBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphCubeRootBlock;
    case "FlowGraphBitwiseAndBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphBitwiseAndBlock;
    case "FlowGraphBitwiseOrBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphBitwiseOrBlock;
    case "FlowGraphBitwiseNotBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphBitwiseNotBlock;
    case "FlowGraphBitwiseXorBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphBitwiseXorBlock;
    case "FlowGraphBitwiseLeftShiftBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphBitwiseLeftShiftBlock;
    case "FlowGraphBitwiseRightShiftBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphBitwiseRightShiftBlock;
    case "FlowGraphLengthBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphLengthBlock;
    case "FlowGraphNormalizeBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphNormalizeBlock;
    case "FlowGraphDotBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphDotBlock;
    case "FlowGraphCrossBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphCrossBlock;
    case "FlowGraphRotate2DBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphRotate2DBlock;
    case "FlowGraphRotate3DBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphRotate3DBlock;
    case "FlowGraphTransposeBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-E77BHKUS.js")).FlowGraphTransposeBlock;
    case "FlowGraphDeterminantBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-E77BHKUS.js")).FlowGraphDeterminantBlock;
    case "FlowGraphInvertMatrixBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-E77BHKUS.js")).FlowGraphInvertMatrixBlock;
    case "FlowGraphMatrixMultiplicationBlock":
      return async () => (await import("./flowGraphMatrixMathBlocks-E77BHKUS.js")).FlowGraphMatrixMultiplicationBlock;
    case "FlowGraphBranchBlock":
      return async () => (await import("./flowGraphBranchBlock-PP3FW7NZ.js")).FlowGraphBranchBlock;
    case "FlowGraphSetDelayBlock":
      return async () => (await import("./flowGraphSetDelayBlock-DTUZF4DU.js")).FlowGraphSetDelayBlock;
    case "FlowGraphCancelDelayBlock":
      return async () => (await import("./flowGraphCancelDelayBlock-5YKHXQSV.js")).FlowGraphCancelDelayBlock;
    case "FlowGraphCallCounterBlock":
      return async () => (await import("./flowGraphCounterBlock-XM7LOKDR.js")).FlowGraphCallCounterBlock;
    case "FlowGraphDebounceBlock":
      return async () => (await import("./flowGraphDebounceBlock-OS52HLLE.js")).FlowGraphDebounceBlock;
    case "FlowGraphThrottleBlock":
      return async () => (await import("./flowGraphThrottleBlock-XFL4SHRM.js")).FlowGraphThrottleBlock;
    case "FlowGraphDoNBlock":
      return async () => (await import("./flowGraphDoNBlock-N5QR6SBS.js")).FlowGraphDoNBlock;
    case "FlowGraphFlipFlopBlock":
      return async () => (await import("./flowGraphFlipFlopBlock-TUQCSBNT.js")).FlowGraphFlipFlopBlock;
    case "FlowGraphForLoopBlock":
      return async () => (await import("./flowGraphForLoopBlock-BYLGTHYI.js")).FlowGraphForLoopBlock;
    case "FlowGraphMultiGateBlock":
      return async () => (await import("./flowGraphMultiGateBlock-MSWTYCRA.js")).FlowGraphMultiGateBlock;
    case "FlowGraphSequenceBlock":
      return async () => (await import("./flowGraphSequenceBlock-K5KUG46N.js")).FlowGraphSequenceBlock;
    case "FlowGraphSwitchBlock":
      return async () => (await import("./flowGraphSwitchBlock-BQPN2PY5.js")).FlowGraphSwitchBlock;
    case "FlowGraphWaitAllBlock":
      return async () => (await import("./flowGraphWaitAllBlock-HRDADBP5.js")).FlowGraphWaitAllBlock;
    case "FlowGraphWhileLoopBlock":
      return async () => (await import("./flowGraphWhileLoopBlock-DN2VWEWH.js")).FlowGraphWhileLoopBlock;
    case "FlowGraphConsoleLogBlock":
      return async () => (await import("./flowGraphConsoleLogBlock-G6NCT4V6.js")).FlowGraphConsoleLogBlock;
    case "FlowGraphConditionalBlock":
      return async () => (await import("./flowGraphConditionalDataBlock-YQYEBOXX.js")).FlowGraphConditionalDataBlock;
    case "FlowGraphConstantBlock":
      return async () => (await import("./flowGraphConstantBlock-3SUVJQ34.js")).FlowGraphConstantBlock;
    case "FlowGraphTransformCoordinatesSystemBlock":
      return async () => (await import("./flowGraphTransformCoordinatesSystemBlock-LVVO5VO4.js")).FlowGraphTransformCoordinatesSystemBlock;
    case "FlowGraphGetAssetBlock":
      return async () => (await import("./flowGraphGetAssetBlock-HHRVTACM.js")).FlowGraphGetAssetBlock;
    case "FlowGraphGetPropertyBlock":
      return async () => (await import("./flowGraphGetPropertyBlock-IVOTIKQG.js")).FlowGraphGetPropertyBlock;
    case "FlowGraphSetPropertyBlock":
      return async () => (await import("./flowGraphSetPropertyBlock-OOZWKT5Y.js")).FlowGraphSetPropertyBlock;
    case "FlowGraphGetVariableBlock":
      return async () => (await import("./flowGraphGetVariableBlock-RRYIUMYY.js")).FlowGraphGetVariableBlock;
    case "FlowGraphSetVariableBlock":
      return async () => (await import("./flowGraphSetVariableBlock-VC4L2J7I.js")).FlowGraphSetVariableBlock;
    case "FlowGraphJsonPointerParserBlock":
      return async () => (await import("./flowGraphJsonPointerParserBlock-CJJXT2A6.js")).FlowGraphJsonPointerParserBlock;
    case "FlowGraphLeadingZerosBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphLeadingZerosBlock;
    case "FlowGraphTrailingZerosBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphTrailingZerosBlock;
    case "FlowGraphOneBitsCounterBlock":
      return async () => (await import("./flowGraphMathBlocks-RNB3XXF7.js")).FlowGraphOneBitsCounterBlock;
    case "FlowGraphCombineVector2Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphCombineVector2Block;
    case "FlowGraphCombineVector3Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphCombineVector3Block;
    case "FlowGraphCombineVector4Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphCombineVector4Block;
    case "FlowGraphCombineMatrixBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphCombineMatrixBlock;
    case "FlowGraphCombineMatrix2DBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphCombineMatrix2DBlock;
    case "FlowGraphCombineMatrix3DBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphCombineMatrix3DBlock;
    case "FlowGraphExtractVector2Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphExtractVector2Block;
    case "FlowGraphExtractVector3Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphExtractVector3Block;
    case "FlowGraphExtractVector4Block":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphExtractVector4Block;
    case "FlowGraphExtractMatrixBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphExtractMatrixBlock;
    case "FlowGraphExtractMatrix2DBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphExtractMatrix2DBlock;
    case "FlowGraphExtractMatrix3DBlock":
      return async () => (await import("./flowGraphMathCombineExtractBlocks-S3OCPXII.js")).FlowGraphExtractMatrix3DBlock;
    case "FlowGraphTransformVectorBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphTransformBlock;
    case "FlowGraphTransformCoordinatesBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphTransformCoordinatesBlock;
    case "FlowGraphConjugateBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphConjugateBlock;
    case "FlowGraphAngleBetweenBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphAngleBetweenBlock;
    case "FlowGraphQuaternionFromAxisAngleBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphQuaternionFromAxisAngleBlock;
    case "FlowGraphAxisAngleFromQuaternionBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphAxisAngleFromQuaternionBlock;
    case "FlowGraphQuaternionFromDirectionsBlock":
      return async () => (await import("./flowGraphVectorMathBlocks-DKBERKNW.js")).FlowGraphQuaternionFromDirectionsBlock;
    case "FlowGraphMatrixDecompose":
      return async () => (await import("./flowGraphMatrixMathBlocks-E77BHKUS.js")).FlowGraphMatrixDecomposeBlock;
    case "FlowGraphMatrixCompose":
      return async () => (await import("./flowGraphMatrixMathBlocks-E77BHKUS.js")).FlowGraphMatrixComposeBlock;
    case "FlowGraphBooleanToFloat":
      return async () => (await import("./flowGraphTypeToTypeBlocks-A7BE2BWL.js")).FlowGraphBooleanToFloat;
    case "FlowGraphBooleanToInt":
      return async () => (await import("./flowGraphTypeToTypeBlocks-A7BE2BWL.js")).FlowGraphBooleanToInt;
    case "FlowGraphFloatToBoolean":
      return async () => (await import("./flowGraphTypeToTypeBlocks-A7BE2BWL.js")).FlowGraphFloatToBoolean;
    case "FlowGraphIntToBoolean":
      return async () => (await import("./flowGraphTypeToTypeBlocks-A7BE2BWL.js")).FlowGraphIntToBoolean;
    case "FlowGraphIntToFloat":
      return async () => (await import("./flowGraphTypeToTypeBlocks-A7BE2BWL.js")).FlowGraphIntToFloat;
    case "FlowGraphFloatToInt":
      return async () => (await import("./flowGraphTypeToTypeBlocks-A7BE2BWL.js")).FlowGraphFloatToInt;
    case "FlowGraphEasingBlock":
      return async () => (await import("./flowGraphEasingBlock-RTP77UXI.js")).FlowGraphEasingBlock;
    case "FlowGraphBezierCurveEasing":
      return async () => (await import("./flowGraphBezierCurveEasingBlock-P7Z4JNEO.js")).FlowGraphBezierCurveEasingBlock;
    case "FlowGraphPointerOverEventBlock":
      return async () => (await import("./flowGraphPointerOverEventBlock-PIULZSHJ.js")).FlowGraphPointerOverEventBlock;
    case "FlowGraphPointerOutEventBlock":
      return async () => (await import("./flowGraphPointerOutEventBlock-N7H4KEBV.js")).FlowGraphPointerOutEventBlock;
    case "FlowGraphPointerDownEventBlock":
      return async () => (await import("./flowGraphPointerDownEventBlock-ENZPPP7H.js")).FlowGraphPointerDownEventBlock;
    case "FlowGraphPointerUpEventBlock":
      return async () => (await import("./flowGraphPointerUpEventBlock-KGITPVLU.js")).FlowGraphPointerUpEventBlock;
    case "FlowGraphPointerMoveEventBlock":
      return async () => (await import("./flowGraphPointerMoveEventBlock-FSD7AKAK.js")).FlowGraphPointerMoveEventBlock;
    case "FlowGraphContextBlock":
      return async () => (await import("./flowGraphContextBlock-7OEGHB2D.js")).FlowGraphContextBlock;
    case "FlowGraphArrayIndexBlock":
      return async () => (await import("./flowGraphArrayIndexBlock-3KTIYASU.js")).FlowGraphArrayIndexBlock;
    case "FlowGraphCodeExecutionBlock":
      return async () => (await import("./flowGraphCodeExecutionBlock-HSNMBTZE.js")).FlowGraphCodeExecutionBlock;
    case "FlowGraphIndexOfBlock":
      return async () => (await import("./flowGraphIndexOfBlock-7RNRSK4I.js")).FlowGraphIndexOfBlock;
    case "FlowGraphFunctionReference":
      return async () => (await import("./flowGraphFunctionReferenceBlock-K3VXTZ2L.js")).FlowGraphFunctionReferenceBlock;
    case "FlowGraphDataSwitchBlock":
      return async () => (await import("./flowGraphDataSwitchBlock-ESSLQVVI.js")).FlowGraphDataSwitchBlock;
    case "FlowGraphDebugBlock":
      return async () => (await import("./flowGraphDebugBlock-OB6IAV6G.js")).FlowGraphDebugBlock;
    // Physics
    case "FlowGraphPhysicsCollisionEventBlock":
      return async () => (await import("./flowGraphPhysicsCollisionEventBlock-D5YZ3OX2.js")).FlowGraphPhysicsCollisionEventBlock;
    case "FlowGraphApplyForceBlock":
      return async () => (await import("./flowGraphApplyForceBlock-ZPENIZ66.js")).FlowGraphApplyForceBlock;
    case "FlowGraphApplyImpulseBlock":
      return async () => (await import("./flowGraphApplyImpulseBlock-COTHM4OS.js")).FlowGraphApplyImpulseBlock;
    case "FlowGraphSetLinearVelocityBlock":
      return async () => (await import("./flowGraphSetLinearVelocityBlock-N6DBFMSA.js")).FlowGraphSetLinearVelocityBlock;
    case "FlowGraphSetAngularVelocityBlock":
      return async () => (await import("./flowGraphSetAngularVelocityBlock-6RVJTV4Y.js")).FlowGraphSetAngularVelocityBlock;
    case "FlowGraphSetPhysicsMotionTypeBlock":
      return async () => (await import("./flowGraphSetPhysicsMotionTypeBlock-LIHT52O4.js")).FlowGraphSetPhysicsMotionTypeBlock;
    case "FlowGraphGetLinearVelocityBlock":
      return async () => (await import("./flowGraphGetLinearVelocityBlock-SVAZSKJE.js")).FlowGraphGetLinearVelocityBlock;
    case "FlowGraphGetAngularVelocityBlock":
      return async () => (await import("./flowGraphGetAngularVelocityBlock-F5DFJ3SG.js")).FlowGraphGetAngularVelocityBlock;
    case "FlowGraphGetPhysicsMassPropertiesBlock":
      return async () => (await import("./flowGraphGetPhysicsMassPropertiesBlock-TOLQ5CSX.js")).FlowGraphGetPhysicsMassPropertiesBlock;
    // Audio
    case "FlowGraphPlaySoundBlock":
      return async () => (await import("./flowGraphPlaySoundBlock-XS5RDB2S.js")).FlowGraphPlaySoundBlock;
    case "FlowGraphStopSoundBlock":
      return async () => (await import("./flowGraphStopSoundBlock-HYXGUXCJ.js")).FlowGraphStopSoundBlock;
    case "FlowGraphPauseSoundBlock":
      return async () => (await import("./flowGraphPauseSoundBlock-ABEFZ65Z.js")).FlowGraphPauseSoundBlock;
    case "FlowGraphSetSoundVolumeBlock":
      return async () => (await import("./flowGraphSetSoundVolumeBlock-RE7N733B.js")).FlowGraphSetSoundVolumeBlock;
    case "FlowGraphSoundEndedEventBlock":
      return async () => (await import("./flowGraphSoundEndedEventBlock-FDRUWEQP.js")).FlowGraphSoundEndedEventBlock;
    case "FlowGraphGetSoundVolumeBlock":
      return async () => (await import("./flowGraphGetSoundVolumeBlock-AYESIROJ.js")).FlowGraphGetSoundVolumeBlock;
    case "FlowGraphIsSoundPlayingBlock":
      return async () => (await import("./flowGraphIsSoundPlayingBlock-UEK43JHT.js")).FlowGraphIsSoundPlayingBlock;
    default:
...
function ParseFlowGraph(serializationObject, options, resolvedClasses) {
  ...
  const dataInMap = /* @__PURE__ */ new Map();
  const dataOutMap = /* @__PURE__ */ new Map();
  const signalInMap = /* @__PURE__ */ new Map();
  const signalOutMap = /* @__PURE__ */ new Map();
...
function ParseFlowGraphBlockWithClassType(serializationObject, parseOptions, classType) {
  ...
  for (let i = 0; i < serializationObject.dataInputs.length; i++) {
    ...
    if (dataInput) {
      ...
      if (serializationObject.dataInputs[i].defaultValue !== void 0) {
...
var gltfToFlowGraphMapping = {
  ...
  "event/send": {
    ...
    extraProcessor(gltfBlock, declaration, _mapping, parser, serializedObjects) {
      ...
      const eventId = (_a = eventConfiguration.value) == null ? void 0 : _a[0];
  ...
  "event/receive": {
    ...
    validation(gltfBlock, interactivityGraph) {
      ...
      const event = (_b = interactivityGraph.events) == null ? void 0 : _b[eventId];
      if (!event) {
  ...
  "flow/switch": {
    ...
    validation(gltfBlock) {
      var _a;
      const cases = (_a = gltfBlock.configuration) == null ? void 0 : _a.cases;
  ...
  "flow/waitAll": {
    ...
    validation(gltfBlock) {
      var _a, _b, _c;
      if (typeof ((_c = (_b = (_a = gltfBlock.configuration) == null ? void 0 : _a.inputFlows) == null ? void 0 : _b.value) == null ? void 0 : _c[0]) !== "number") {
  ...
  "variable/interpolate": {
    ...
    extraProcessor(gltfBlock, _declaration, _mapping, parser, serializedObjects) {
      ...
      const propertyIndex = (_b2 = (_a2 = gltfBlock.configuration) == null ? void 0 : _a2.variable.value) == null ? void 0 : _b2[0];
      ...
      if (typeof ((_d = (_c = serializedValueInterpolation.config) == null ? void 0 : _c.animationType) == null ? void 0 : _d.value) === "undefined") {
  ...
  _parseNodeConfiguration(node, block, nodeMapping, blockType) {
    ...
    if (gltfConfiguration) {
      for (const key in gltfConfiguration) {
        ...
        const propertyMapping = (_a = nodeMapping.configuration) == null ? void 0 : _a[key];
        ...
        if (belongsToBlock) {
          let value = propertyMapping == null ? void 0 : propertyMapping.defaultValue;
          if (gltfProperty == null ? void 0 : gltfProperty.value) {
            value = gltfProperty.value;
          }
          if (!(propertyMapping == null ? void 0 : propertyMapping.isArray)) {
            if (value.length !== 1) {
              Logger.Warn(`Invalid non-array value length: ${value.length}`);
            }
            value = value[0];
          }
          if (propertyMapping == null ? void 0 : propertyMapping.dataTransformer) {
            value = propertyMapping.dataTransformer(value, this);
          }
          if (value !== void 0) {
            block.config[(propertyMapping == null ? void 0 : propertyMapping.name) || key] = {
              value
            };
          }
        }
...
addToBlockFactory(NAME37, "FlowGraphGLTFDataProvider", async () => {
  return (await import("./flowGraphGLTFDataProvider-YVGA6RI4.js")).FlowGraphGLTFDataProvider;
});
...
addNewInteractivityFlowGraphMapping("event/onSelect", NAME39, {
  ...
  extraProcessor(gltfBlock, _declaration, _mapping, _arrays, serializedObjects, context, globalGLTF) {
    ...
    serializedObject.config = serializedObject.config || {};
    serializedObject.config.glTF = globalGLTF;
    const nodeIndex = (_c = (_b = (_a = gltfBlock.configuration) == null ? void 0 : _a["nodeIndex"]) == null ? void 0 : _b.value) == null ? void 0 : _c[0];
    ...
    context._userVariables[variableName] = {
      className: "Mesh",
      id: (_e = (_d = globalGLTF == null ? void 0 : globalGLTF.nodes) == null ? void 0 : _d[nodeIndex]._babylonTransformNode) == null ? void 0 : _e.id,
      uniqueId: (_g = (_f = globalGLTF == null ? void 0 : globalGLTF.nodes) == null ? void 0 : _f[nodeIndex]._babylonTransformNode) == null ? void 0 : _g.uniqueId
    };
    return serializedObjects;
  }
});
