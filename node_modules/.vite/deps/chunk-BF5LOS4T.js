...
} from "./chunk-OBO3LFVR.js";
import {
  _GetCompatibleTextureLoader
} from "./chunk-BL5XEBNJ.js";
import {
  SphericalPolynomial
} from "./chunk-ZCPHVF4N.js";
import {
  BaseTexture
} from "./chunk-ZPN6227P.js";
import {
  PerfCounter
} from "./chunk-PXSRYJNC.js";
import {
  GetExponentOfTwo,
  IsExponentOfTwo
...
ThinEngine.prototype._readTexturePixelsSync = function(texture, width, height, faceIndex = -1, level = 0, buffer = null, flushRenderer = true, noDataConversion = false, x = 0, y = 0) {
  ...
  if (faceIndex > -1 && (texture.is2DArray || texture.is3D)) {
    gl.framebufferTextureLayer(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, (_a = texture._hardwareTexture) == null ? void 0 : _a.underlyingResource, level, faceIndex);
  } else if (faceIndex > -1) {
    gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_CUBE_MAP_POSITIVE_X + faceIndex, (_b = texture._hardwareTexture) == null ? void 0 : _b.underlyingResource, level);
  } else {
    gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_2D, (_c = texture._hardwareTexture) == null ? void 0 : _c.underlyingResource, level);
  }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-2PFPF7BV.js");
    const textures = [];
...
//# sourceMappingURL=chunk-BF5LOS4T.js.map
